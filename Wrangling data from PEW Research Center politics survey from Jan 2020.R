...
#Manipulate
pew_politics_jan_2020$republican[pew_politics_jan_2020$Number <= 500 & pew_politics_jan_2020$confederate == 1] <- 1

#write csv to folder that will be upload to gitHub
write.csv(pew_politics_jan_2020, "~/R/pew-politics-jan2020/artificial_data.csv")
